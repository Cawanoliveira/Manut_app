    ...
    if (mode === 'chart') {
      ...
      return '<div class="summary-column-chart"><div class="summary-column-stage">' +
        ...
        '<div class="summary-column-grid">' + categories.map(function(key, index) {
          ...
          return '<button class="summary-column-item' + selectedClass + '" onclick="abrirResumoAgrupado(\'' + tipo + '\', \'' + escapeJs(key) + '\', this)">' +
            ...
            '<span class="summary-column-label">' + escapeHtml(key) + '</span>' +
          '</button>';
        }).join('') + '</div></div></div>';
    }
